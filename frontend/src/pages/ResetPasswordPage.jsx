...
const ResetPasswordPage = () => {
    ...
    const handleSubmit = async (e) => {
       ...
       try {
        ...
        console.log(error)
        toast.error('Failed to reset password')(error.message || 'Error resetting password')
       }
    }
        ...
        >
            <div className='p-8'>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    whileTap={{scale:0.98}}
                    className='w-full py-3 px04 bg-gradient-to-r from-green-500 to-emerald-600 
                    text-white font-bold rounded-lg shadow-lg hover:from-green-600 hover:to-emerald-700 focus:outline-none
                    focus:ring-2 focus:ring-green-500 focus-ring-offset-2 focus:focus-ring-offset-gray-900 transition duration-200'
                    type='submit'
                    disabled={isLoading}
                    >
