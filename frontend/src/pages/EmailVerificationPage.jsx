...
const EmailVerificationPage = () => {
    ...
    const handleChange = (index,value) => {
        // if the value is number ,update the code at current index
        const newCode = [...code]
    ...
    shadow-xl overflow-hidden'>
        ...
        >
            ...
            <form onSubmit={handleSubmit} className='space-y-6'>
                ...
                <motion.button className='w-full bg-gradient-to-r from-green-500 to-emerald-600 text-white font-bold py-3 px-4 
